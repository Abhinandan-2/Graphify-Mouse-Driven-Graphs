    ...
    public class Main extends Application {
        ...
        public void start(Stage primaryStage) throws Exception {
           ...
           // Circle cir=new Circle(8);
            Scene fhhg= new Scene(pane, 1000, 400);
            fhhg.setFill(Color.CRIMSON);

            primaryStage.setScene(fhhg);
            //
              boolean gg=true;
            ...
            a1.setOnAction(e->{
                String[] ftr=a1.getText().split(" ");
              /*  Stage window=new Stage();
                window.initModality(Modality.APPLICATION_MODAL);
                window.setTitle("path");
                Pane lay= new Pane();
                window.setScene(new Scene(lay,1000,400));*/
                String[] pth=gr.printPath(a1.getText()).split(" ");
                double prvx=0;
                double prvy=0;
               // Circle cty=new Circle(8);
                SequentialTransition ss=new SequentialTransition();
                Shape cre=new Circle(8);
                for(int i=1;i<pth.length;i++){
                    String nd=pth[i];
                    if(i!=1){

                        if(Character.toLowerCase(ftr[2].charAt(0))=='p'){
                            cre= new Polyline(
                                    0.00,8.00,
                                    16.00,8.00,
                                    8.00,0.00,
                            ...
                            cre.setStroke(Color.YELLOW);
                        }
                        else if(Character.toLowerCase((ftr[2].charAt(0)))=='c'&&Character.toLowerCase(ftr[2].charAt(1))=='r'){
                            cre =new Polyline(
                                    0.00,0.00,
                                    16.00,16.00,
                                    16.00,0.00,
                            ...
                            cre.setStroke(Color.BLUE);
                        }
                        else if(Character.toLowerCase(ftr[2].charAt(0))=='t'){
                            cre=new Polygon(
                                    0.00,0.00
                                    ,0.00,20.00,10.00,10.00
                            );
                            cre.setStroke(Color.FIREBRICK);
                            cre.setFill(Color.GREEN);
                        }
                        else if(Character.toLowerCase(ftr[2].charAt(0))=='c'){
                             cre=new Circle(8);
                             cre.setStroke(Color.SIENNA);
                             cre.setFill(Color.BLUE);
                        }
                        else if(Character.toLowerCase(ftr[2].charAt(0))=='r'){
                             cre= new Rectangle(10,10);
                             cre.setStroke(Color.PINK);
                             cre.setFill(Color.YELLOW);
                        }
                        else if(Character.toLowerCase(ftr[2].charAt(0))=='e'){
                            cre=new Ellipse(10,8);
                        cre.setStroke(Color.GREEN);
                        cre.setFill(Color.CADETBLUE);
                        }


                       // cre.setFill(Color.SIENNA);
                       // cre.setLayoutX(prvx);
                        //cre.setLayoutY(prvy);
                        ...
                        trans.setFromX(prvx);
                        trans.setFromY(prvy);
                        trans.setToX(gr.searchVertex(nd).getX());
                        trans.setToY(gr.searchVertex(nd).getY());
                        trans.setDuration(Duration.seconds(3));

                       // trans.setAutoReverse(true);
                        //trans.setCycleCount(Animation.INDEFINITE);
                       ss.getChildren().add(trans); //trans.play();
                        Line li=new Line(prvx,prvy,gr.searchVertex(nd).getX(),gr.searchVertex(nd).getY());
                        li.setStroke(Color.CADETBLUE);
                    ...
                    ct.setLayoutX(prvx);
                    ct.setLayoutY(prvy);
                    ct.setFill(Color.AQUAMARINE);
                    pane.getChildren().add(ct);

                }
                pane.getChildren().add(cre);
                ss.setAutoReverse(true);
                ss.setCycleCount(Animation.INDEFINITE);
                ss.setNode(cre);
                ss.play();
